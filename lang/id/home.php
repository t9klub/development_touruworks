...
return [
    ...
    'title-site' => 'Beranda',
    'title-1' => 'Tentang',
    'content-1' => 'Website ini dirancang untuk membantu pengembangan ultilitas untuk keperluan komisi yang kita jalanin, beserta menjadi dokumentasi catatan pengembangan. <br><br>
    ...
    'content-2' => 'Kalian dapat memeriksa livechat yang telah kita bikin melalui dummy chat yang telah kita rancang di link berikut <a href="/dummy" class="underline underline-offset-2 text-black dark:text-white hover:text-yellow-400 transition-all duration-300" > Dummy Livechat.</a>
                                <br>
                                <br>
    ...
    'content-3-1'=> 'Kalian tidak perlu lagi untuk melakukan copy paste setiap ruang tunggu streaming youtube.
                                <br><br>
                                sekarang kalian dapat mencoba sekarang langsung dengan cara ini',
                                
    'subtitle-3-1'=> 'Buka Halaman Profile Youtube',
    'subtext-3-1' => 'Copy semua url profile youtube kalian seperti gambar yang ada di bawah',
    'subtitle-3-2' => 'Paste Url Profile Kalian',
    'subtext-3-2' => 'Silahkan paste url profile livechat kalian pada kolom dibawah' ,
    'subtext-3-2-1' => 'paste url youtube disini',
    'subtitle-3-3' => 'Copy hasil generate url ke Browser OBS/streamlabs', 

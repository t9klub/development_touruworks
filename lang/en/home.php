...
return [
    ...
    'content-2' => 'You can check the live chat that we have created through the dummy chat that we have designed in the following link.<a href="/dummy" class="underline underline-offset-2 text-black dark:text-white hover:text-yellow-400 transition-all duration-300" > Dummy Livechat.</a>
    <br>
    <br>
    or you can try via the Dekreza website which you can access here <a href="https://rzytblc.netlify.app/" class="underline underline-offset-2 text-black dark:text-white hover:text-yellow-400 transition-all duration-300" target="_blank">https://rzytblc.netlify.app/</a> ',

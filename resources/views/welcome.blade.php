                                    ...
                                    <li class="relative flex-1 ">
                                        ...
                                        class="w-6 h-6 aspect-square bg-gray-50 border-2 relative z-10 border-gray-200 rounded-full flex justify-center items-center mr-3 text-sm  lg:w-10 lg:h-10">2</span>
                                            <div class="flex flex-col">
                                                ...
                                                <input id="url_input" class="placeholder:text-gray/50 p-2 text-gray border rounded mr-4 w-52 xl:w-72 focus:outline-none bg-gray-200" placeholder="Put profile youtube url here..." >
